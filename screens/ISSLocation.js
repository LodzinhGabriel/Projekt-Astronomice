...
import { Text, View, StyleSheet, ImageBackground, StatusBar, SafeAreaView, Platform, TouchableOpacity, Image, Alert } from 'react-native';
            ...
            return(
                <View style = {styles.container}>
                    ...
                    <View style = {styles.titleContainer}>
                        <Text style = {styles.titleText}>Localização EEI</Text>
                    </View>
